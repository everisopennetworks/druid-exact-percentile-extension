...
import com.nttdata.druid.aggregation.percentiles.aggregator.DoublesReservoirToSUMPostAggregator;
...
public class DoublesReservoirSUMOperatorConversion implements SqlOperatorConversion {
    private static final String NAME = "DR_GET_SUM";
    ...
    public PostAggregator toPostAggregator(
        ...
        return new DoublesReservoirToSUMPostAggregator(
