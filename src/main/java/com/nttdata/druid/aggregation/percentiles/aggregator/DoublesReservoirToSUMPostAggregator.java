...
@JsonTypeName("doublesReservoirToSUM")
public class DoublesReservoirToSUMPostAggregator implements PostAggregator {
    ...
    @JsonCreator
    public DoublesReservoirToSUMPostAggregator(
    ...
    public boolean equals(Object o) {
        ...
        final DoublesReservoirToSUMPostAggregator that = (DoublesReservoirToSUMPostAggregator) o;
